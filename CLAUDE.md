...
**Description**: Bluetooth Manager - Device pairing and audio connectivity

**Purpose**: Provide bluetooth manager - device pairing and audio connectivity functionality for the pkgs ecosystem.
...
**Executables**:
- `.local/bin/bt` - Main executable
- `.local/bin/bt-expect` - Main executable
- `.local/bin/bt.backup` - Main executable
- `.local/bin/bt.phase4.backup` - Main executable
...
1. **Test installation**: `stow bt`
2. **Test functionality**: Run main commands and verify output
3. **Test uninstallation**: `stow -D bt`
