...
All notable changes to @system/bt will be documented in this file.
...
- Declared external command requirements: bluetoothctl, dmenu, git, rofi, scanner
...
- Package naming now includes collection scope: `@system/bt`
